...
import org.studio4sv.tponr.client.item.FilterBlockItem.FilterBlockItemRenderer;
...
public class FilterBlockItem extends BlockItem implements GeoItem {
    ...
    public FilterBlockItem(Block block, Properties properties) {
    ...
    private PlayState predicate(AnimationState<FilterBlockItem> clockItemAnimationState) {
