package dev.lemonnik.ponr.registers;

import dev.lemonnik.ponr.PONR;
import dev.lemonnik.ponr.blocks.custom.BunkerDoor.BunkerDoorBlock;
import dev.lemonnik.ponr.blocks.custom.BunkerDoor.BunkerDoorSubBlock;
import dev.lemonnik.ponr.blocks.custom.Clock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, PONR.MOD_ID);
